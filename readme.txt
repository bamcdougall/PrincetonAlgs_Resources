This repository is a collection miscellaneous resources that one might find
...
CAUTION: some resources are quite dated, but still useful. This means that some
thougt must be given with regard to current implementation.
